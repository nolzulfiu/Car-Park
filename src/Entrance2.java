...
public class Entrance2 {
	...
	public static void main(String[] args) throws IOException {
        ...
        System.out.println("Initialised Entrance 2 client and IO connections");
        ...
        while (true) {
            ...
            if (fromUser != null) {
                System.out.println("Entrance 2 sending " + fromUser + " to Car Park Server");
                out.println(fromUser);
            }
            
            System.out.println("Entrance 2 received " + in.readLine() + " from Car Park Server");
        }
