...
public class Exit1 {
	...
	public static void main(String[] args) throws IOException {
        ...
        System.out.println("Initialised Exit 1 client and IO connections");
        ...
        while (true) {
            ...
            if (fromUser != null) {
                System.out.println("Exit 1 sending " + fromUser + " to Car Park Server");
                out.println(fromUser);
            }
            
            System.out.println("Exit 1 received " + in.readLine() + " from Car Park Server");
        }
